const SPREADSHEET_ID = '1H40T0CIjmd0OW55SJLKechqXgGanAAMJ8P89qZhxhVo';
...
function doPost(e: GoogleAppsScript.Events.DoPost) {
  try {
    ...
    if (sheetKey !== 'RSVP' && sheetKey !== 'WISHES') {
      return jsonResponse_({ ok: false, error: 'Invalid sheet. Use RSVP or WISHES.' });
    }
...
function parseQueryString_(query: string) {
...
function getOrCreateSheet_(ss: GoogleAppsScript.Spreadsheet.Spreadsheet, name: string) {
