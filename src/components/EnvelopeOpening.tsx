      ...
      <style>{`
        ...
        * {
        ...
        .scene {
          ...
          padding: 20px;
          background: radial-gradient(ellipse at 30% 20%, #f0f8ff 0%, #e6f2ff 40%, #add8e6 100%);
          perspective: 1500px;
          overflow: hidden;
        ...
        .scene::before {
          ...
          top: -100px;
          right: -100px;
          background: radial-gradient(circle, rgba(95,158,160,0.15) 0%, transparent 70%);
        }
        .scene::after {
          width: 300px;
          height: 300px;
        ...
        .card-container {
          position: absolute;
          inset: 0;
          background: linear-gradient(180deg, #ffffff 0%, #fdfdfd 50%, #f0f8ff 100%);
          border-radius: 6px;
          z-index: 2;
          overflow: hidden;
          box-shadow: inset 0 0 30px rgba(95,158,160,0.05);
          transform: scale(1);
          ...
          <div className="card-container">
            <div className="card-border">
              ...
              <svg className="corner-ornament corner-tl" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg">
                <path d="M5,5 L5,25 C5,15 15,5 25,5 L5,5 Z" fill="none" stroke="#5f9ea0" strokeWidth="0.8" opacity="0.6"/>
                <path d="M5,5 L5,18 C5,12 12,5 18,5 L5,5 Z" fill="#5f9ea0" opacity="0.08"/>
                <circle cx="5" cy="5" r="2" fill="#5f9ea0" opacity="0.5"/>
                <path d="M8,5 Q12,8 5,12" stroke="#5f9ea0" strokeWidth="0.5" fill="none" opacity="0.4"/>
                <path d="M5,8 Q8,12 12,5" stroke="#5f9ea0" strokeWidth="0.5" fill="none" opacity="0.4" className="shimmer"/>
              </svg>
              ...
              {guestName && (
                <div style={{ marginTop: 'auto', marginBottom: '8px', zIndex: 2, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                  <div style={{ fontFamily: '"Cormorant Garamond", serif', fontStyle: 'italic', color: '#4682b4', fontSize: '15px', marginBottom: '4px' }}>We cordially invite</div>
                  <div style={{ fontFamily: '"Montserrat", sans-serif', fontWeight: 500, color: '#104e8b', fontSize: '12px', textTransform: 'uppercase', letterSpacing: '0.15em', padding: '0 10px', textAlign: 'center', lineHeight: '1.4' }}>
                    {prefix} {guestName}
                  </div>
                </div>
              )}
              ...
              <div className="text-details">
                ...
                <span className="text-date">Saturday 10 October 2026 At 10:30 AM</span>
                <span className="text-church">Chiesa Santa Maria Della Stella</span><br />
                25 Via Stella Napoli
              </div>
            </div>
          </div>
