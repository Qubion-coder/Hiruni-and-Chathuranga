...
export const RSVPForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const scriptUrl = 'https://script.google.com/macros/s/AKfycbxsg-HPM5dE6t1oel_9U9mhbc8gLdNI7XYvsIm9jhtqVyw02iv1Ith307YZOyZcfqWxIA/exec';
      ...
      if (scriptUrl) {
        ...
        // Simulate network request latency if URL is missing
    ...
    <div className="max-w-5xl mx-auto px-6 relative py-10">
      ...
      >
        ...
        <div className="lg:w-1/2 lg:pr-10 mb-12 lg:mb-0 relative text-center lg:text-left">
          ...
          <div className="mt-4 mb-6 bg-brand-champagne/50 px-6 py-4 rounded-2xl border border-brand-beige/20 flex flex-col gap-2">
            <p className="text-stone-600 font-sans text-sm font-medium mb-1">RSVP Contacts</p>
            <div>
              <p className="text-stone-800 font-serif text-lg leading-none">Alexida</p>
              <a href="tel:3279271201" className="text-brand-beige-deep font-sans text-base font-semibold hover:underline">327 927 1201</a>
            </div>
            <div>
              <p className="text-stone-800 font-serif text-lg leading-none mt-2">Anura</p>
              <a href="tel:3805893986" className="text-brand-beige-deep font-sans text-base font-semibold hover:underline">380 589 3986</a>
            </div>
          </div>
